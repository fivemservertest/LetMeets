...
class detailroom2 extends StatefulWidget {
  final list;
  final reserve_id;
  final host;

  const detailroom2({Key key, this.list, this.reserve_id, this.host})
      : super(key: key);

  @override
  State<detailroom2> createState() => _detailroom2State();
}

class _detailroom2State extends State<detailroom2> {
  String team_name = "";
  String hostname = "";
  String firstname = '';
  String lastname = '';
