...
class NavigationVerifyScreen extends StatefulWidget {
  @override
  _NavigationVerifyScreenState createState() => _NavigationVerifyScreenState();
}

class _NavigationVerifyScreenState extends State<NavigationVerifyScreen> {
  Widget screenView;
  ...
  @override
  void initState() {
    drawerIndex = DrawerIndex.Verify;
