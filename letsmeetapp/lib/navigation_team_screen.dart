...
class NavigationTeamScreen extends StatefulWidget {
  @override
  _NavigationTeamScreenState createState() => _NavigationTeamScreenState();
}

class _NavigationTeamScreenState extends State<NavigationTeamScreen> {
  Widget screenView;
